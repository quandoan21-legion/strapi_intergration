...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  info: {
    description: 'Danh m\u1EE5c s\u1EF1 ki\u1EC7n (Web, AI, Mobile, Cloud, ...)';
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  info: {
    description: 'Th\u00F4ng tin s\u1EF1 ki\u1EC7n (title, m\u00F4 t\u1EA3, ng\u00E0y gi\u1EDD, h\u00ECnh \u1EA3nh, danh m\u1EE5c)';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiRegistrationRegistration extends Schema.CollectionType {
  ...
  info: {
    description: 'Th\u00F4ng tin ng\u01B0\u1EDDi \u0111\u0103ng k\u00FD tham gia s\u1EF1 ki\u1EC7n';
  ...
  attributes: {
    ...
    source: Attribute.String & Attribute.DefaultTo<'mobile-app'>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::registration.registration',
      'oneToOne',
...
export interface ApiUserUser extends Schema.CollectionType {
  ...
  info: {
    description: 'User records created via API';
    displayName: 'User';
    pluralName: 'users';
    singularName: 'user';
  };
  ...
  attributes: {
    create_by: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::user.user', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    edit_at: Attribute.DateTime;
    edit_by: Attribute.DateTime;
    email: Attribute.Email & Attribute.Required & Attribute.Unique;
    has_entrance_exam: Attribute.Boolean & Attribute.DefaultTo<false>;
