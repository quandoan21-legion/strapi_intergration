"use strict";(self.webpackChunktech_events_strapi=self.webpackChunktech_events_strapi||[]).push([[4648],{40216(dt,S,s){s.d(S,{S:()=>N});var t=s(92132),_=s(47610),P=s(94061),X=s(48653),F=s(83997),G=s(30893);const w=(0,_.Ay)(P.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
